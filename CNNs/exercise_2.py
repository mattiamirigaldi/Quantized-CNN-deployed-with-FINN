...
if __name__ == '__main__':
    ...
    from torch_neural_networks_library import model_ex2
    from ex4_MNIST import model_MNIST_quant, model_MNIST_quant_brevitas, LeNet5
    ...
    # MNIST images resized to be 32x32
    ...
    # model = model_ex2()  # create model instance, initialize parameters, send to device
    ...
    tag = ''
    FINNManager.export(model.to("cpu"), input_shape=in_tensor,
                       export_path=model_directory + model_name + tag + 'finn.onnx')
    BrevitasONNXManager.export(model.cpu(), input_shape=in_tensor,
                               export_path=model_directory + model_name + tag + 'brevitas.onnx')
